...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *   {@code MyApi.Endpoint.List request = myApi.endpoint().list(parameters ...)}
   * </pre>
   *
  ...
  public class Endpoint {
    ...
    /**
     * Create a request for the method "endpoint.getNearby".
     *
     ...
     * @return the request
     */
    public GetNearby getNearby() throws java.io.IOException {
      GetNearby result = new GetNearby();
      initialize(result);
      return result;
    }

    public class GetNearby extends MyApiRequest<pt.castro.francesinhas.backend.myApi.model.CollectionResponseItemHolder> {

      private static final String REST_PATH = "collectionresponse_itemholder";

      /**
       * Create a request for the method "endpoint.getNearby".
       *
       * This request holds the parameters needed by the the myApi server.  After setting any optional
       * parameters, call the {@link GetNearby#execute()} method to invoke the remote operation. <p>
       * {@link
      ...
      public GetNearby setCount(java.lang.Integer count) {
        this.count = count;
        return this;
      }
      ...
      public GetNearby setCursor(java.lang.String cursor) {
        this.cursor = cursor;
        return this;
      }
      ...
      public GetNearby setLongitude(java.lang.Float longitude) {
      ...
      public GetNearby setLatitude(java.lang.Float latitude) {
   ...
   * @return the request
   */
  public AddUser addUser(java.lang.String userId, java.lang.String userEmail) throws java.io.IOException {
    AddUser result = new AddUser(userId, userEmail);
    initialize(result);
    return result;
  }
  ...
  public class AddUser extends MyApiRequest<pt.castro.francesinhas.backend.myApi.model.UserHolder> {
    ...
    private static final String REST_PATH = "addUser/{userId}/{userEmail}";
     ...
     * @since 1.13
     */
    protected AddUser(java.lang.String userId, java.lang.String userEmail) {
    ...
    public AddUser setUserEmail(java.lang.String userEmail) {
  ...
  /**
   * Create a request for the method "queryItems".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link QueryItems#execute()} method to invoke the remote operation.
   *
   * @param query
   * @return the request
   */
  public QueryItems queryItems(java.lang.String query) throws java.io.IOException {
    QueryItems result = new QueryItems(query);
    initialize(result);
    return result;
  }

  public class QueryItems extends MyApiRequest<pt.castro.francesinhas.backend.myApi.model.CollectionResponseItemHolder> {

    private static final String REST_PATH = "queryItems/{query}";

    /**
     * Create a request for the method "queryItems".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link QueryItems#execute()} method to invoke the remote operation. <p>
     * {@link
     * QueryItems#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param query
     * @since 1.13
     */
    protected QueryItems(java.lang.String query) {
      super(MyApi.this, "POST", REST_PATH, null, pt.castro.francesinhas.backend.myApi.model.CollectionResponseItemHolder.class);
      this.query = com.google.api.client.util.Preconditions.checkNotNull(query, "Required parameter query must be specified.");
    }

    @Override
    public QueryItems setAlt(java.lang.String alt) {
      return (QueryItems) super.setAlt(alt);
    }

    @Override
    public QueryItems setFields(java.lang.String fields) {
      return (QueryItems) super.setFields(fields);
    }

    @Override
    public QueryItems setKey(java.lang.String key) {
      return (QueryItems) super.setKey(key);
    }

    @Override
    public QueryItems setOauthToken(java.lang.String oauthToken) {
      return (QueryItems) super.setOauthToken(oauthToken);
    }

    @Override
    public QueryItems setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (QueryItems) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public QueryItems setQuotaUser(java.lang.String quotaUser) {
      return (QueryItems) super.setQuotaUser(quotaUser);
    }

    @Override
    public QueryItems setUserIp(java.lang.String userIp) {
      return (QueryItems) super.setUserIp(userIp);
    }
    ...
    public QueryItems setQuery(java.lang.String query) {
      this.query = query;
      return this;
    }
    ...
    public QueryItems setCount(java.lang.Integer count) {
      this.count = count;
      return this;
    }
    ...
    public QueryItems setCursor(java.lang.String cursor) {
      this.cursor = cursor;
      return this;
    }

    @Override
    public QueryItems set(String parameterName, Object value) {
      return (QueryItems) super.set(parameterName, value);
    }
  }
